...
### Example 1: Multiplying two signals
...
### Example 1: Controlling the volume
...
### Example 1: Controlling the volume with a slider
...
### Example 1: Knobs instead of sliders
...
### Example 1: Vertical and horizontal Layout
...
### Example 1: Differentiate the volume of the two channels
...
### Example 1: Having many channels
...
### Example 1: Delay of 0.1 second on the right channel
...
### Example 1: Stereo Delay with freeze
...
Similarly, a sawtooth signal can be approximated by additive synthesis, by adding an infinite series of harmonics (see [https://fr.wikipedia.org/wiki/Signal_en_dents_de_scie](https://fr.wikipedia.org/wiki/Signal_en_dents_de_scie)).
