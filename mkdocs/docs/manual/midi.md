...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust0/exfaust0.dsp" target="editor">
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust1/exfaust1.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust2/exfaust2.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust3/exfaust3.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust4/exfaust4.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust5/exfaust5.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust6/exfaust6.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust7/exfaust7.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust8/exfaust8.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust9/exfaust9.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust10/exfaust10.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust11/exfaust11.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/midi/exfaust12/exfaust12.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
