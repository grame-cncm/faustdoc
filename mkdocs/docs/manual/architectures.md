...
- the [Julia](https://julialang.org) backend can be used with the [minimal.jl](https://github.com/grame-cncm/faust/blob/master-dev/architecture/julia/minimal.jl) or the [portaudio.jl](https://github.com/grame-cncm/faust/tree/master-dev/architecture/julia/audio) used in `faust2portaudiojulia` script.
