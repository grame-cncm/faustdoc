...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/compiler/exfaust0/exfaust0.dsp" target="editor">
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/compiler/exfaust1/exfaust1.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
...
<a href="https://faustide.grame.fr/?code=https://faustdoc.grame.fr/manual/compiler/exfaust2/exfaust2.dsp" target="editor">
<button type="button" class="btn btn-primary">Try it Yourself >></button></a>
</div>
<!-- /faust-run -->
