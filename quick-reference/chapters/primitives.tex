...
\item two fixed outputs: the first one is the currently accessed sound length in samples, the second one is the currently accessed sound nominal sample rate in Hz
