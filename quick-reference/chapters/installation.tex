...
The \faust source distribution \lstinline'faust-2.83.1.tar.gz' can be downloaded from GitHub (\myurl{https://github.com/grame-cncm/faust/releases}).
...
The resulting \lstinline'faust-2.83.1/' folder should contain the following elements:
