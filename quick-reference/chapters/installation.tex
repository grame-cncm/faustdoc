...
The \faust source distribution \lstinline'faust-2.40.0.tar.gz' can be downloaded from GitHub (\myurl{https://github.com/grame-cncm/faust/releases}).

\section{Organization of the distribution}
The first thing is to decompress the downloaded archive. 
\begin{lstlisting}
	tar xzf faust-2.40.0.tar.gz
\end{lstlisting}

The resulting  \lstinline'faust-2.40.0/' folder should contain the following elements:
...
It should output:
\begin{lstlisting}
	FAUST, DSP to C++ compiler, Version 2.40.0
