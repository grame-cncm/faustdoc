...
The \faust source distribution \lstinline'faust-2.79.3.tar.gz' can be downloaded from GitHub (\myurl{https://github.com/grame-cncm/faust/releases}).

\section{Organization of the distribution}
The first thing is to decompress the downloaded archive. 
\begin{lstlisting}
	tar xzf faust-2.79.3.tar.gz
\end{lstlisting}

The resulting \lstinline'faust-2.79.3/' folder should contain the following elements:
