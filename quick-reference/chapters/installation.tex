...
The \faust source distribution \lstinline'faust-2.85.9.tar.gz' can be downloaded from GitHub (\myurl{https://github.com/grame-cncm/faust/releases}).
...
The resulting \lstinline'faust-2.85.9/' folder should contain the following elements:
