...
static void test25(int argc, char* argv[])
{
    createLibContext();
    {
        ...
        Box osc = DSPToBoxes("import(\"stdfaust.lib\"); process = os.osc(440);", 0, nullptr, &inputs, &outputs, error_msg);
...
static void test26(int argc, char* argv[])
{
    createLibContext();
    {
        ...
        Box filter = DSPToBoxes("import(\"stdfaust.lib\"); process = fi.lowpass(5);", 0, nullptr, &inputs, &outputs, error_msg);
