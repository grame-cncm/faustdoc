...
dependencies:
	...
	@test -f ./mkdocs/docs/js/faust-web-component.js || curl -L --create-dirs https://cdn.jsdelivr.net/npm/@grame/faust-web-component@0.4.2/dist/faust-web-component.js -o ./mkdocs/docs/js/faust-web-component.js
